...
/**
 * Represents a Rectangle that can draw itself.
 *
 * @author Chris Blades
 * @author Don Coffin
 * @author Benny Reese
...
public class Rectangle extends AbstractTwoPointShape {
    ...
    /**
     * Creates a new Rectangle that will be drawn with the specified
     * color with it's upper left corner at <i>start</i> and lower
     * right corner at <i>end</i>
     *
    ...
    /**
     * Draws this Rectangle to the given graphical context in the given color.
     *
