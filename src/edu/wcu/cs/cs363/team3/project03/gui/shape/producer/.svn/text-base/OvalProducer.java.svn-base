...
import edu.wcu.cs.cs363.team3.project03.gui.shape.Oval;

/**
 * Implements logic for producing Oval objects based on user input via
 * the mouse.
 *
 * @author Chris Blades
 * @author Don Coffin
...
public class OvalProducer extends AbstractTwoPointShapeProducer {
    ...
    /**
     * Creates a new OvalProducer with a default drawColor.
     */
    public OvalProducer() {
        super();
    }
    ...
    /**
     * Creates a new OvalProducer with the given drawColor.
     * 
     * @param drawColor Color in which to produce Shapes.
     */
    public OvalProducer(Color drawColor) {
        super(drawColor);
    }

    /**
     * Called when the user releases the mouse button.  Defines the
     * end point for the Oval being produced and so notifies 
     * ShapeCreationListeners that the permanent Oval object has been
     * created.
     * 
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        notifyShapeCreated(new Oval(getDrawColor(),
                                    orderedStart, 
                                    orderedEnd));
    }
     ...
     * Notifies ShapeCreationListeners that an intermediary Oval 
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        notifyShapeInProgress(new Oval(getDrawColor(),
                                    orderedStart, 
                                    orderedEnd));
    }
}
